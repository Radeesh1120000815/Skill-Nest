...
| :--- | :--- |
| **Frontend** | React 19, Vite, TailwindCSS (v3), PostCSS, React Router DOM (v7), Axios, Lucide Icons, React Icons |
| **Backend** | Node.js, Express (v5), Mongoose (v9), MongoDB |
| **Integrations** | Google Gemini API (v1beta), Cloudinary SDK, Multer, Nodemailer, JSON Web Token (JWT), BcryptJS |
| **Tooling & Dev** | Nodemon, ESLint, Git |
