...
const SIDEBAR_SECTIONS = [
   ...
   },
   {
      ...
      links: [
         { label: 'All Sessions', to: '/admin/sessions', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
   ...
   },
   {
      ...
      links: [
         { label: 'All Users', to: '/admin/users', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
