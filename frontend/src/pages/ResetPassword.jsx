...
const ResetPassword = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-gradient-to-br from-indigo-50 via-white to-purple-50 selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <main className="flex-1 flex items-center justify-center p-6 mt-[84px] relative overflow-hidden">
        <div className="max-w-4xl w-full bg-white rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row transition-all duration-300 relative z-10">
          ...
          <div className="md:w-1/2 bg-gradient-to-br from-emerald-500 to-teal-700 text-white p-12 flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 -mb-10 -ml-10 w-48 h-48 bg-emerald-300 opacity-20 rounded-full blur-3xl pointer-events-none"></div>
